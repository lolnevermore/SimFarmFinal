...
public class Movement : MonoBehaviour
{
    ...
    public void Interact()
    {
        ...
        {
            if (currentPlant[0].tag == "PotatoSeed")
            {
                scoreManager.GetComponent<Score>().score += 15;
            }
            else if (currentPlant[0].tag == "CornSeed")
            {
                scoreManager.GetComponent<Score>().score += 20;
            }
            else if(currentPlant[0].tag == "CarrotSeed")
            {
                scoreManager.GetComponent<Score>().score += 10;
            }
